...
def create_app():
    ...
    # Load instance configuration (instance/config.py) if present
    # This allows storing secrets in the instance folder for permanence.
    ...
    for key in ('GMAIL_USER', 'GMAIL_APP_PASSWORD', 'SENDGRID_API_KEY', 'FROM_EMAIL'):
